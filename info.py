...
API_ID = int(environ['19379883'])
API_HASH = environ['35250b1c23769c18ac7e82e20b05e90b']
BOT_TOKEN = environ['5828528396:AAF7Ffm2xxL5tBjbItW8sB6h5rgRk5svk7U']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1606667548').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1606667548').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1001681447022')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE URI', "mongodb+srv://powermovies:<521368>@cluster0.e86qeg4.mongodb.net/?retryWrites=true&w=majority")
